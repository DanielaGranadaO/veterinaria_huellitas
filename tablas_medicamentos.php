...
if (isset($_POST['buscar'])) {
  ...
  $sql= "SELECT * FROM medicamentos inner JOIN pacientes ON medicamentos.`MedPaciente`=pacientes.IdPaciente where PacCliente=$Id";
...
<div class="container-fluid px-4">                      
                    ...
                    <div class="container text-center">
                      ...
                      <tbody> 
                        ...
                        <tr>
                          <td><?php echo $mostrar['IdMedicamento']?></td>
                          <td><?php echo $mostrar['MedNombre']?></td>
                          <td><?php echo $mostrar['MedUso']?></td>
                          <td><?php echo $mostrar['MedCantidad']?></td>
