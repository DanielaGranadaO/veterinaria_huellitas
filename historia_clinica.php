...
if (isset($_POST['buscar'])) {
 ...
 $sql= "SELECT * FROM pacientes where PacCliente=$Id";
...
?>
  ...
  <div class="row ">
    <div class="col ">
    <form action="controller/registro_pacientes/actualizar_pacientes.php" method="post" id="form">
			<div class="form">
				<h1>Datos Del Paciente</h1>
                <div class="grupo">
                  <input type="hidden" name="ID" value="<?php echo $mostrar['IdPaciente']?>"  ><span class="barra"></span>
                  <label for=""> </label>
               </div>
				<div class="grupo">
					<input type="text" name="Nombres" value="<?php echo $mostrar['PacNombre']?>"    required><span class="barra"></span>
					<label for="">Nombre </label>
				</div>
				<div class="grupo">
					<input type="date" name="Nacimiento" value="<?php echo $mostrar['PacFechaNacimiento']?>"  required><span class="barra"></span>
					<label for="">Fecha de nacimiento</label>
				</div>
				<div class="grupo">
					
				    <input type="radio" name="gender" value"masculino"  value="<?php echo $mostrar['PacSexo']?>" required checked><span class="barra"></span>
					<label>Masculino</label>
					
					 <input type="radio" name="gender" value"Femenino" value="<?php echo $mostrar['PacSexo']?>" required checked><span class="barra"></span>
					<label>Femenino</label>								
				</div>	              
				<div class="grupo">
					<input type="text" name="Raza" value="<?php echo $mostrar['PacRaza']?>"  required><span class="barra"></span>
					<label for="">Raza</label>
				</div>
				<div class="grupo">
					<input type="text" name="Color" value="<?php echo $mostrar['PacColor']?>" required><span class="barra"></span>
					<label for="">Color</label>
				</div>
 	
				<div class="grupo">
					<input type="text"  name="Cliente" placeholder="identificacio del dueño" value="<?php echo $mostrar['PacCliente']?>" required><span class="barra"></span>
