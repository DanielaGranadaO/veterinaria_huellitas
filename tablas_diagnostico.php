...
<html lang="en">
  ...
  $sql= "SELECT * FROM diagnosticos inner JOIN consultasveterinarias ON diagnosticos.DiaConsultaVeterinaria=consultasveterinarias.IdConsultaVeterinaria INNER JOIN citas on consultasveterinarias.ConCita=citas.IdCita where CitCliente=$Id";
...
<div class="container-fluid px-4">                      
                      ...
                      <tbody> 
                        ...
                        <tr>
                          <td><?php echo $mostrar['IdDiagnostico']?></td>
                          <td><?php echo $mostrar['DiaObservacion']?></td>
