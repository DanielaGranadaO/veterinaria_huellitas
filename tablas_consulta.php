...
<html lang="en">
  ...
  $sql= "SELECT * FROM consultasveterinarias inner JOIN citas ON consultasveterinarias.ConCita=citas.IdCita where CitCliente=$Id";
...
<div class="container-fluid px-4">                      
                      ...
                      <tbody> 
                        ...
                        <tr>
                          <td><?php echo $mostrar['IdConsultaVeterinaria']?></td>
                          <td><?php echo $mostrar['ConObservacion']?></td>
