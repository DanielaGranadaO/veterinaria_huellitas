...
?>
                      ...
                      <div class="row ">
                        <div class="col ">
                        <form action="controller/registro_pacientes/tratamientos/crear_cirugias.php" method="post" id="form">
                                <div class="form">
                                <h1>Cirugias</h1>

                                <div class="grupo">
					<input type="text" name="id" value="<?php echo $mostrar['PacNombre']?>"  required><span class="barra"></span>
					<label for="">Nombre Mascota</label>
				</div>
                
                <div class="grupo">
					<input type="text" name="id" value="<?php echo $mostrar['IdPaciente']?>"  required><span class="barra"></span>
					<label for="">Id Mascota</label>
				</div>

                                <div class="input-group">
    <input type="text" name="Nombre" class="form-control" placeholder="Nombre De La Cirugia"/>
    <span class="input-group-addon">--</span>
    <input type="text" name="Tipo" class="form-control" placeholder="Tipo De Cirugia"/>
</div>                
                <div class="grupo">
                <label for="exampleFormControlTextarea1" class="form-label">Recomendaciones</label>
  <textarea class="form-control"  name="Recomendaciones" id="exampleFormControlTextarea1" rows="10"></textarea>
					
				</div>	
                                </div>
                                                         
                <button type="submit">Ingresar</button><span class="barra"></span>
                        </form>
                                </div>                              
                            </div>
                      </div>
