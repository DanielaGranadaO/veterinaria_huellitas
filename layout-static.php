...
<html lang="en">
  ...
  <div class="row ">
    <div class="col ">
    <form action="controller/registro_pacientes/crear_pacientes.php" method="post" id="form">
			<div class="form">
				<h1>Registro De Mascotas</h1>
				<div class="grupo">
					<input type="text" name="Nombres"  required><span class="barra"></span>
					<label for="">Nombre </label>
				</div>
				<div class="grupo">
					<input type="date" name="Nacimiento"  required><span class="barra"></span>
					<label for="">Fecha de nacimiento</label>
				</div>
				<div class="grupo">
					
				    <input type="radio" name="gender" value"masculino" required checked><span class="barra"></span>
					<label>Masculino</label>
					
					 <input type="radio" name="gender" value"Femenino" required checked><span class="barra"></span>
					<label>Femenino</label>								
				</div>	              
				<div class="grupo">
					<input type="text" name="Raza"  required><span class="barra"></span>
				...
				<div class="grupo">
					<input type="text"  name="Cliente" placeholder="identificacio del dueño" required><span class="barra"></span>
