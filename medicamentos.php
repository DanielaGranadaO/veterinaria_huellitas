...
?>
                      ...
                      <div class="row ">
                        <div class="col ">
                        <form action="controller/registro_pacientes/tratamientos/crear_medicamentos.php" method="post" id="form">
                        <div class="form">
                                <h1>Medicamentos</h1>
      
<div class="input-group">
    <input type="text" name="Nombre" class="form-control" placeholder="Nombre Del Medicamento"/>
...
<div class="grupo">
                ...
                <div class="grupo">
					<input type="text"  name="Nombre" value="<?php echo $mostrar['PacNombre']?>" ><span class="barra"></span>
					<label for="">Nombre Mascota</label>
				</div>

                </div>
                <div class="grupo">
                <label for="exampleFormControlTextarea1" class="form-label">Uso</label>
  <textarea class="form-control"  name="Uso" id="exampleFormControlTextarea1" rows="10"></textarea>
