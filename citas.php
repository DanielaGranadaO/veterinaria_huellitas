...
<html lang="en">
  ...
  <a class="nav-link text-white"  href="tratamiento.php">Tratamiento</a>
  ...
  <div class="container  text=center align-content-center justify-content-center">			
                ...
                <button type="submit" name="buscar">Buscar</button><span class="barra"></span>
                    ...
                    <br><br>
<!---- inicio consulta buscar ----->
<?php
if (isset($_POST['buscar'])) {
    $Id= $_POST['Identificacion'];
  $sql= "SELECT PacCliente,IdPaciente FROM pacientes where PacCliente=$Id";
...
?>
                      ...
                      <div class="row ">
                        <div class="col ">
                        <form action="controller/registro_pacientes/citas/crear_citas.php" method="post" id="form">
                                <div class="form">
                                <h1>Citas</h1>                      
                                <div class="grupo">
				...
				<div class="grupo">
					<input type="time" name="Hora"  required><span class="barra"></span>
					<label for="">Hora Cita</label>
				</div>

				<div class="grupo">
					<input type="text" name="Cliente" value="<?php echo $mostrar['PacCliente']?>"  required><span class="barra"></span>
					<label for="">Cliente</label>
				</div>
				<div class="grupo">
					<input type="text" name="Paciente" value="<?php echo $mostrar['IdPaciente']?>" required><span class="barra"></span>
