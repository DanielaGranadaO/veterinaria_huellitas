...
<html lang="en">
  ...
  <div class="container  text=center align-content-center justify-content-center">			
                ...
                <button type="submit" name="buscar">Buscar</button><span class="barra"></span>
                    ...
                    <!----- termina formulario buscar--->		
                    <br><br>
<!-----Consulta para buscar el cliente------>
                    <?php
if (isset($_POST['buscar'])) {
    $Id= $_POST['Identificacion'];
    $sql= "SELECT * FROM citas INNER join pacientes ON citas.CitPaciente=pacientes.IdPaciente where CitCliente=$Id";
...
?>
                      ...
                      <div class="row ">
                        <div class="col ">
                        <form action="controller/registro_pacientes/registro_evolciones/crear_evolucion_consulta.php" method="post" id="form">
                        <h1>Consulta Veterinaria</h1>
                                <div class="grupo">
					<input type="hidden" name="Paciente" value="<?php echo $mostrar['CitPaciente']?>" required><span class="barra"></span>
				...
				<div class="grupo">
					<input type="text" name="id" value="<?php echo $mostrar['IdCita']?>"  required><span class="barra"></span>
