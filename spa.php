...
?>
                      ...
                      <div class="row ">
                        <div class="col ">
                        <form action="controller/registro_pacientes/registro_evolciones/crear_evolucion_spa.php" method="post" id="form">
                                <div class="form">
                                <h1>Spa</h1>
                                <div class="grupo">
                ...
                <div class="grupo">
					<input type="hidden" name="Paciente" value="<?php echo $mostrar['IdPaciente']?>" required><span class="barra"></span>
