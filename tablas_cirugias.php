...
if (isset($_POST['buscar'])) {
  ...
  $sql= "SELECT * FROM cirugias inner JOIN pacientes ON cirugias.CirPaciente=pacientes.IdPaciente where PacCliente=$Id";
...
<div class="container-fluid px-4">                      
                    ...
                    <div class="container text-center">
                      ...
                      <tbody> 
                        ...
                        <tr>
                          <td><?php echo $mostrar['IdCirugia']?></td>
                          <td><?php echo $mostrar['CirNombre']?></td>
                          <td><?php echo $mostrar['CirTipo']?></td>
                          <td><?php echo $mostrar['CirRecomendaciones']?></td>
