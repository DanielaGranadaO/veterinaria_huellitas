            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">                      
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="tablas_clientes.php">Tabla Clientes</a></li>
                    ...
                    <div class="container text-center">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $mostrar['PacNombre']?></td>
                          <td><?php echo $mostrar['PacFechaNacimiento']?></td>
                          <td><?php echo $mostrar['PacSexo']?></td>
                          <td><?php echo $mostrar['PacRaza']?></td>
                          <td><?php echo $mostrar['PacColor']?></td>
                          <td><?php echo $mostrar['PacCliente']?></td>
                          <td>
                            
                            
                            <!------ EDITAR------>
                          <a href="modificar_pacientes.php?id=<?php echo $mostrar['IdPaciente']?>">Editar</a>
                            <!------ ELIMINAR------>
                          <form action="controller/registro_pacientes/borrar_pacientes.php" method="post">
                              <input type="hidden" value="<?php echo $mostrar['IdPaciente']?>" name="Id" readonly>
