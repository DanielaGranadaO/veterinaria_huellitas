...
<html lang="en">
  ...
  <div class="row ">
    <div class="col ">
    <form action="controller/registro_pacientes/registro_clientes/crear_clientes.php" method="post" id="form">
			<div class="form">
				...
				<div class="grupo">
					<input type="text" name="Apellidos"  required><span class="barra"></span>
				...
				<div class="grupo">
					<input type="text" name="Telefono"  required><span class="barra"></span>
